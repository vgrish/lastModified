...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('lastmodified_core_path', null,
                    $modx->getOption('core_path') . 'components/lastmodified/') . 'model/';
            $modx->addPackage('lastmodified', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/lastmodified/model/schema/lastmodified.mysql.schema.xml';
